<template>
    ...
    <div class="search-panel-wrapper">
      <div>
        ...
        <button @click="addEntry" class="add panel-btn">Добавить</button>
        <button @click="backHandler" class="add panel-btn">Назад</button>
      </div>
...
export default Vue.extend({
  ...
  methods: {
    showEntry(e: any) {
      this.$router.push(`/patients/entries/${e.data.Product_ID}`);
    },
    addEntry(e: string) {
